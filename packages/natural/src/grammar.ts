...
var grammar = {
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$1", "__", "datevalue_base$subexpression$2", "__", "month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[6]}-${months[d[4].toLowerCase()]}-XX`, confidence: 0.9 })},
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$3", "__", "datevalue_base$subexpression$4", "__", "datevalue_base$subexpression$5", "__", "month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[8]}-${months[d[6].toLowerCase()]}-XX`, confidence: 0.9 })},
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$6", "__", "datevalue_base$subexpression$7", "__", "datevalue_base$subexpression$8", "__", "month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[8]}-${months[d[6].toLowerCase()]}-XX`, confidence: 0.9 })},
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$9", "__", "datevalue_base$subexpression$10", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[4]}-XX-XX`, confidence: 0.9 })},
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$11", "__", "datevalue_base$subexpression$12", "__", "datevalue_base$subexpression$13", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[6]}-XX`, confidence: 0.9 })},
    ...
    {"name": "datevalue_base$subexpression$37", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$36", "__", "ordinal_day", "__", "datevalue_base$subexpression$37", "__", "month_name", "_", {"literal":","}, "_", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[10]}-${months[d[6].toLowerCase()]}-${pad2(d[2])}`, confidence: 0.95 })},
    {"name": "datevalue_base$subexpression$38", "symbols": [/[tT]/, /[hH]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base$subexpression$39", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$38", "__", "ordinal_day", "__", "datevalue_base$subexpression$39", "__", "month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[8]}-${months[d[6].toLowerCase()]}-${pad2(d[2])}`, confidence: 0.95 })},
    {"name": "datevalue_base$subexpression$40", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["ordinal_day", "__", "datevalue_base$subexpression$40", "__", "month_name", "_", {"literal":","}, "_", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[8]}-${months[d[4].toLowerCase()]}-${pad2(d[0])}`, confidence: 0.95 })},
    {"name": "datevalue_base$subexpression$41", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["ordinal_day", "__", "datevalue_base$subexpression$41", "__", "month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[6]}-${months[d[4].toLowerCase()]}-${pad2(d[0])}`, confidence: 0.95 })},
    ...
    {"name": "datevalue_base", "symbols": ["month_name", "__", "day_num", "_", {"literal":","}, "_", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[6]}-${months[d[0].toLowerCase()]}-${pad2(d[2])}`, confidence: 0.95 })},
    {"name": "datevalue_base", "symbols": ["month_name", "__", "day_num", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[4]}-${months[d[0].toLowerCase()]}-${pad2(d[2])}`, confidence: 0.95 })},
    {"name": "datevalue_base", "symbols": ["day_num", "__", "month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[4]}-${months[d[2].toLowerCase()]}-${pad2(d[0])}`, confidence: 0.95 })},
    {"name": "datevalue_base", "symbols": ["month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${d[2]}-${months[d[0].toLowerCase()]}`, confidence: 0.95 })},
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$string$1", "__", "digit", "digit", {"literal":"0"}, "datevalue_base$string$2", {"literal":"s"}], "postprocess": d => ({ type: 'date', edtf: `${d[2]}${d[3]}XX`, confidence: 0.95 })},
    {"name": "datevalue_base$string$3", "symbols": [{"literal":"0"}, {"literal":"'"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "datevalue_base", "symbols": ["digit", "digit", {"literal":"0"}, "datevalue_base$string$3", {"literal":"s"}], "postprocess": d => ({ type: 'date', edtf: `${d[0]}${d[1]}XX`, confidence: 0.95 })},
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$string$4", "__", "digit", "digit", {"literal":"0"}, "datevalue_base$string$5"], "postprocess": d => ({ type: 'date', edtf: `${d[2]}${d[3]}XX`, confidence: 0.95 })},
    {"name": "datevalue_base$string$6", "symbols": [{"literal":"0"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "datevalue_base", "symbols": ["digit", "digit", {"literal":"0"}, "datevalue_base$string$6"], "postprocess": d => ({ type: 'date', edtf: `${d[0]}${d[1]}XX`, confidence: 0.95 })},
    ...
    {"name": "datevalue_base$subexpression$43$subexpression$1", "symbols": [/[cC]/, /[eE]/, /[nN]/, /[tT]/, /[uU]/, /[rR]/, /[yY]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base$subexpression$43", "symbols": ["datevalue_base$subexpression$43$subexpression$1"]},
    {"name": "datevalue_base$subexpression$43$subexpression$2", "symbols": [/[cC]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base$subexpression$43", "symbols": ["datevalue_base$subexpression$43$subexpression$2", {"literal":"."}]},
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$42", "__", "ordinal_century", "__", "datevalue_base$subexpression$43"], "postprocess":  d => {
          const centuryNum = d[2];
          const year = (centuryNum - 1) * 100;
          return { type: 'date', edtf: `${String(year).substring(0, 2)}XX`, confidence: 0.95 };
        } },
    {"name": "datevalue_base$subexpression$44$subexpression$1", "symbols": [/[cC]/, /[eE]/, /[nN]/, /[tT]/, /[uU]/, /[rR]/, /[yY]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base$subexpression$44", "symbols": ["datevalue_base$subexpression$44$subexpression$1"]},
    {"name": "datevalue_base$subexpression$44$subexpression$2", "symbols": [/[cC]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base$subexpression$44", "symbols": ["datevalue_base$subexpression$44$subexpression$2", {"literal":"."}]},
    {"name": "datevalue_base", "symbols": ["ordinal_century", "__", "datevalue_base$subexpression$44"], "postprocess":  d => {
          const centuryNum = d[0];
          const year = (centuryNum - 1) * 100;
          return { type: 'date', edtf: `${String(year).substring(0, 2)}XX`, confidence: 0.95 };
        } },
    {"name": "datevalue_base$subexpression$45", "symbols": [/[tT]/, /[hH]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base$subexpression$46", "symbols": [/[cC]/, /[eE]/, /[nN]/, /[tT]/, /[uU]/, /[rR]/, /[yY]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$45", "__", "spelled_century", "__", "datevalue_base$subexpression$46"], "postprocess": d => ({ type: 'date', edtf: `${d[2]}XX`, confidence: 0.95 })},
    {"name": "datevalue_base$subexpression$47", "symbols": [/[cC]/, /[eE]/, /[nN]/, /[tT]/, /[uU]/, /[rR]/, /[yY]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["spelled_century", "__", "datevalue_base$subexpression$47"], "postprocess": d => ({ type: 'date', edtf: `${d[0]}XX`, confidence: 0.95 })},
    {"name": "datevalue_base$subexpression$48", "symbols": [/[tT]/, /[hH]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$48", "__", "spelled_decade"], "postprocess": d => ({ type: 'date', edtf: `19${d[2]}X`, confidence: 0.9 })},
    ...
    {"name": "datevalue_base", "symbols": ["year_num", "_", "datevalue_base$string$14"], "postprocess": d => ({ type: 'date', edtf: `${d[0]}~`, confidence: 0.95 })},
    {"name": "datevalue_base$string$15", "symbols": [{"literal":"i"}, {"literal":"s"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "datevalue_base", "symbols": ["year_num", "datevalue_base$string$15"], "postprocess": d => ({ type: 'date', edtf: `${d[0]}~`, confidence: 0.95 })},
    {"name": "datevalue_base", "symbols": ["year_num"], "postprocess": d => ({ type: 'date', edtf: d[0], confidence: 0.95 })},
