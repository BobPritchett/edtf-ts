...
var grammar = {
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$36", "__", "ordinal_day", "__", "datevalue_base$subexpression$37", "__", "month_name", "_", {"literal":","}, "_", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${pad4(d[10])}-${months[d[6].toLowerCase()]}-${pad2(d[2])}`, confidence: 0.95 })},
    ...
    {"name": "datevalue_base", "symbols": ["datevalue_base$subexpression$38", "__", "ordinal_day", "__", "datevalue_base$subexpression$39", "__", "month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${pad4(d[8])}-${months[d[6].toLowerCase()]}-${pad2(d[2])}`, confidence: 0.95 })},
    {"name": "datevalue_base$subexpression$40", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["ordinal_day", "__", "datevalue_base$subexpression$40", "__", "month_name", "_", {"literal":","}, "_", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${pad4(d[8])}-${months[d[4].toLowerCase()]}-${pad2(d[0])}`, confidence: 0.95 })},
    {"name": "datevalue_base$subexpression$41", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "datevalue_base", "symbols": ["ordinal_day", "__", "datevalue_base$subexpression$41", "__", "month_name", "__", "year_num"], "postprocess": d => ({ type: 'date', edtf: `${pad4(d[6])}-${months[d[4].toLowerCase()]}-${pad2(d[0])}`, confidence: 0.95 })},
